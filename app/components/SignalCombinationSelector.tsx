  ...
  return (
    <div className="mt-4">
      <label
        ...
        className="block text-sm font-medium text-gray-700dark:bg-gray-800 text-gray-900 dark:text-white shadow"
      >
        Signal Combination
      </label>
      <select
        ...
        className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm rounded-md dark:bg-gray-800 text-gray-900 dark:text-white shadow"
      >
        {options.map((option) => (
